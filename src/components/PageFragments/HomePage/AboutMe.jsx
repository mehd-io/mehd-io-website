...
const pageText = {
  paraOne: `I’m a data geek entrepreneur who’s passionate about Big data, Data science, Web App and Music. With more than 7 years of experience, I got the opportunity to work on multiple aspect regarding data engineering, that includes data pipelines (stream/batch), data modeling, orchestration, infrastructure and from time to time analytical reports using dashboarding tools.`,
      ...
      <Row gutter={[10, 10]}>
        <Col xs={24} sm={24} md={12} lg={8}>
          <AboutTile
            ...
            alt="coding"
            textH3="Tech Content Creator"
            textH4="Blogger / Youtuber"
          />
        </Col>
        <Col xs={24} sm={24} md={12} lg={8}>
          <AboutTile
